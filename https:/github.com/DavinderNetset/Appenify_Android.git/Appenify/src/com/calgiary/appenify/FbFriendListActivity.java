...
public class FbFriendListActivity extends FragmentActivity{
	...
	static String userIdStr = "";
	 public static void populateParameters(Intent intent, String userId, boolean multiSelect, boolean showTitleBar) {
	       ...
	       // userIdStr = (FriendPickerFragment.USER_ID_BUNDLE_KEY, userId);
	    }
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_fb_friend_list);
		  ...
		  FragmentManager fm = getSupportFragmentManager();
	        ...
	        if (savedInstanceState == null) {
	            ...
	            args.putString("com.facebook.android.PickerFragment.Selection", userIdStr);
	        ...
	        friendPickerFragment.setOnErrorListener(new PickerFragment.OnErrorListener() {
	            ...
	            public void onError(PickerFragment<?> fragment, FacebookException error) {
	                FbFriendListActivity.this.onError(error);
	            }
	        });
	    ...
	    protected void onStart() {
	        ...
	        try {
	            ...
	            if (selectedUsers != null && !selectedUsers.isEmpty()) {
	                ...
	                Log.i("Friend List: ", "Friend List: " +friendPickerFragment);
	            }
