...
public class PeopleAttendingAdapter extends BaseAdapter implements ListAdapter {
...
//		ArrayList<HashMap<String, String>> eventlist;
		...
		public PeopleAttendingAdapter(Context c,
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				convertView = mInflater.inflate(R.layout.popup_people_attending, null);
