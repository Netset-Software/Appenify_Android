...
public class ListViewSwipeGesture implements View.OnTouchListener {
    ...
    public ViewGroup mDownView,old_mDownView, close;
                    ...
                    if (rect.contains(x, y)) {
                        ...
                        if(mDownView_parent.getChildCount()==1){
                            ...
                            if(SwipeType==Dismiss){
                                ...
                                HalfDrawable	=	activity.getResources().getDrawable(R.drawable.dropdown_icon);
                            }
                           SetBackGroundforList();
                           //SetBackGroundforListClose();
                        }
    ...
    private void SetBackGroundforList() {
        ...
        lp1 =new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,android.widget.RelativeLayout.LayoutParams.WRAP_CONTENT);
         ...
         mDownView_parent_txt1.setBackgroundColor(Color.RED);
         mDownView_parent_txt1.setTextColor(Color.WHITE);
         ...
         if(SwipeType==Double){
             ...
             mDownView_parent_txt2.setWidth(0);
             mDownView_parent_txt2.setPadding(0, textheight/4, 0, 0);
             mDownView_parent_txt2.setHeight(textheight);
             mDownView_parent_txt2.setBackgroundColor(Color.RED);
             mDownView_parent_txt2.setTextColor(Color.WHITE);
    ...
    public void SetBackGroundforListClose() {
		 mDownView_parent_txt1 =	new TextView(activity.getApplicationContext());
       lp1 =new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,android.widget.RelativeLayout.LayoutParams.WRAP_CONTENT);
        lp1.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        mDownView_parent_txt1.setId(111111);
        ...
        mDownView_parent_txt1.setWidth(0);
        mDownView_parent_txt1.setPadding(0,0, 0, 0);
        mDownView_parent_txt1.setHeight(0);
        mDownView_parent_txt1.setBackgroundColor(Color.RED);
        mDownView_parent_txt1.setTextColor(Color.WHITE);
